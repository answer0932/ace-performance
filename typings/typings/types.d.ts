export interface ACE_DataConsumption {
    beacon: number;
    css: number;
    fetch: number;
    img: number;
...
export interface ACE_NavigationTiming {
    fetchTime?: number;
    workerTime?: number;
    totalTime?: number;
    downloadTime?: number;
...
export interface ACE_NetworkInformation {
    downlink?: number;
...
export declare type ACE_Data = number | ACE_NavigationTiming | ACE_NetworkInformation;
